...
export default function Hero({ onDenunciar }: HeroProps) {
  return (
    <section
      id="inicio"
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-medium mb-6">
          ...
          Plataforma activa — 47 nuevas denuncias hoy
        </div>
        ...
        <p className="text-foreground-2 text-lg sm:text-xl max-w-2xl mx-auto mb-10">
          La plataforma ciudadana para reportar robos, estafas, fraudes digitales
          y vehículos robados. Colectiva, verificada y anónima.
        </p>
