...
export default function App() {
  ...
  const { reports, filter, setFilter, search, setSearch, vote, addReport, stats, zones, topAccounts, loading, error } = useReports()
      ...
      <main>
        ...
        <section id="feed" className="max-w-7xl mx-auto px-4 sm:px-6 pb-24">
          <div className="flex items-center justify-between mb-6">
            <h2 className="font-heading font-bold text-xl sm:text-2xl text-foreground">Denuncias recientes</h2>
            ...
            <div className="flex flex-col gap-5">
              ...
              {reports.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  <p className="text-foreground-2 text-sm">No hay denuncias reales para el filtro actual.</p>
                </div>
              ) : (
